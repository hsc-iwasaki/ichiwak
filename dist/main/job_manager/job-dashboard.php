                    ...
                    <tfoot>
                        <tr>
                            <td colspan="<?php echo sizeof($job_dashboard_columns); ?>">
                                <a href="<?php echo esc_url(get_permalink($post_a_job_page_id)); ?>"><?php echo apply_filters('jobhunt_wpjm_job_dashboard_post_a_job_button_text', esc_html__('求人情報を追加', 'jobhunt')); ?></a>
                            </td>
                        </tr>
                    </tfoot>
                <?php endif; ?>
