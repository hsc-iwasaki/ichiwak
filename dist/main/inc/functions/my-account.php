        ...
        <form id="jobhunt_registration_form" class="jobhunt_registration_form" action="#" method="POST">
            ...
            <fieldset>
                ...
                <?php if (apply_filters('jobhunt_register_user_login_enabled', true)) : ?>
                    <p>
                        <label for="jobhunt_register_user_login"><?php esc_html_e('ユーザー名', 'jobhunt'); ?>
                            <input name="jobhunt_user_login" id="jobhunt_register_user_login" class="required" type="text" />
                        </label>
                    </p>
                <?php endif; ?>
                <p>
                    <label for="jobhunt_register_user_email"><?php esc_html_e('メールアドレス', 'jobhunt'); ?>
                ...
                <?php if (apply_filters('jobhunt_register_user_password_enabled', false)) : ?>
                    <p>
                        <label for="jobhunt_register_user_password"><?php esc_html_e('パスワード', 'jobhunt'); ?>
                ...
                <?php if (apply_filters('jobhunt_register_user_role_enabled', true) && jobhunt_is_wp_job_manager_activated()) : ?>
                    <p style="display:none;">
                        <label for="jobhunt_register_user_role"><?php echo esc_html__('登録種別', 'jobhunt'); ?></label>
...
if (!function_exists('jobhunt_login_form_fields')) {
    ...
    ?>
        <div class="entry-header">
            <h3 class="headline"><?php echo apply_filters('jobhunt_login_form_header_title', esc_html__('ログイン', 'jobhunt')); ?></h3>
        </div>
        ...
        <form id="jobhunt_login_form" class="jobhunt_login_form" action="#" method="post">
            ...
            <fieldset>
                <p>
                    <label for="jobhunt_user_login"><?php echo esc_html__('ユーザ名またはメールアドレス', 'jobhunt'); ?>
                        <input name="jobhunt_user_login" id="jobhunt_user_login" class="required" type="text" />
                    </label>
                </p>
                <p>
                    <label for="jobhunt_user_pass"><?php echo esc_html__('パスワード', 'jobhunt'); ?>
                ...
                <p class="lost-pass-btn">
                    <a href="<?php echo esc_url(wp_lostpassword_url(home_url('/'))); ?>" title="<?php echo esc_attr__('Lost Password?', 'jobhunt'); ?>"><?php echo esc_html__('パスワードをお忘れの方', 'jobhunt'); ?></a>
                    <a href="<?php echo get_home_url() ?>/register">はじめての方</a>
                </p>
            </fieldset>
        </form>
