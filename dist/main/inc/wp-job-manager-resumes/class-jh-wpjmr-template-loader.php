 ...
 */
class JH_WPJMR_Template_Loader {
    ...
    public static function init() {
        self::$resumes_page_id  = jh_wpjmr_get_page_id( 'resume' );
    ...
    private static function get_template_loader_default_file() {
        ...
        } elseif ( is_post_type_archive( 'resume' ) || is_page( self::$resumes_page_id ) || is_resume_taxonomy() ) {
...
add_action( 'init', array( 'JH_WPJMR_Template_Loader', 'init' ) );