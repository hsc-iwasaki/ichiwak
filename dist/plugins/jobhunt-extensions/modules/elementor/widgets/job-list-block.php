...
/**
 * Elementor Job List Block Widget.
 *
 * Elementor widget that inserts an embbedable content into the page, from any given URL.
 *
 * @since 1.0.0
 */
class Jobhunt_Elementor_Jobhunt_Job_List_Block extends Widget_Base {

    /**
     * Get widget name.
     *
     * Retrieve Job List Block widget name.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_name() {
        return 'jobhunt_elementor_jobhunt_job_list_block';
    }

    /**
     * Get widget title.
     *
     * Retrieve Job List Block widget title.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_title() {
        return esc_html__( 'Job List Block', 'jobhunt-extensions' );
    }

    /**
     * Get widget icon.
     *
     * Retrieve Job List Block widget icon.
     *
     * @since 1.0.0
     * @access public
     *
     ...
     *
     * Retrieve the list of categories the Job List Block widget belongs to.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    /**
     * Register Job List Block widget controls.
     *
...
Plugin::instance()->widgets_manager->register_widget_type( new Jobhunt_Elementor_Jobhunt_Job_List_Block );