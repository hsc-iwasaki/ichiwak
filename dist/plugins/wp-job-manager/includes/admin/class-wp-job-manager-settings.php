				...
				'job_listings'   => [
					...
					[
						...
						[
							...
							'cb_label'   => __( 'Hide filled positions in job archives/search', 'wp-job-manager' ),
							'desc'       => __( 'Filled positions will not display in your archives or in search.', 'wp-job-manager' ),
							'type'       => 'checkbox',
							'attributes' => [],
						],
						[
							...
							'desc'       => __( 'Expired positions will not display in your archives or in search.', 'wp-job-manager' ),
							'type'       => 'checkbox',
							'attributes' => [],
						],
						[
