            ...
            {tempValue || !expanded ? null : (
                <button
                    ...
                    className={classNames(
                        'w-full cursor-pointer bg-transparent p-4 py-2 text-left text-sm text-wp-theme-500 hover:text-wp-theme-500',
                        {
                            'text-design-main hover:text-design-main':
                        ...
                        className={classNames(
                            'm-0 w-full cursor-pointer bg-transparent pl-0 text-left text-sm font-normal hover:text-wp-theme-500',
                            {
                                ...
                                'hover:text-design-main':
                                    window.extendifyData?.partnerLogo &&
                                    !current,
                                'hover:text-design-main font-semibold':
                                    window.extendifyData?.partnerLogo &&
                                    current,
                            },
                        )}
