...
export const SupportArticles = () => {
    ...
    if (loading || error) {
        return (
            <div className="w-full flex justify-center bg-white border-l border-r border-b border-gray-300 p-4 lg:p-8">
                <Spinner />
    ...
    if (articles && articles?.length === 0) {
        return (
            <div className="w-full bg-white border-l border-r border-b border-gray-300 p-4 lg:p-8">
