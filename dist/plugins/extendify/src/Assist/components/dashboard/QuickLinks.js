...
export const QuickLinks = () => {
    ...
    if (loading || error) {
        return (
            <div className="w-full flex justify-center bg-white border-l border-r border-b border-gray-300 p-4 lg:p-8 rounded-b-lg">
                <Spinner />
            </div>
        )
    }
    ...
    if (quickLinks.length === 0) {
        return (
            <div className="w-full bg-white border-l border-r border-b border-gray-300 p-4 lg:p-8 rounded-b-lg">
