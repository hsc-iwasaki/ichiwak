...
<div id="page" class="hfeed site">
    ...
    do_action( 'jobhunt_top_bar' ); ?>

    <header id="masthead" class="site-header header-v4 <?php echo jobhunt_header_additional_classes(); ?>" style="<?php jobhunt_header_styles(); ?>">
        ...
        <div class="<?php echo jobhunt_has_handheld_header() ? 'desktop-only' : ''; ?> <?php echo jobhunt_has_sticky_header() ? 'jobhunt-stick-this' : ''; ?>">
            <div class="container">
                <div class="site-header-inner">
                     ...
                     * @hooked jobhunt_secondary_nav            - 30
                     */
                    do_action( 'jobhunt_header_v4' ); ?>
