...
if (!function_exists('jobhunt_home_search_block')) {
    ...
    function jobhunt_home_search_block($args = array())
    {
        ...
        ?><header class=" display-b <?php echo esc_attr($section_class); ?>" <?php echo jobhunt_site_content_bg_image(); ?>>
                <div class="float">
                    <img class="float-1" src="<?php echo get_template_directory_uri() ?>/img/top/bg_img04.png" alt="">
                    <img class="float-2" src="<?php echo get_template_directory_uri() ?>/img/top/bg_img03.png" alt="">
                    <img class="float-3" src="<?php echo get_template_directory_uri() ?>/img/top/bg_img02.png" alt="">
                    <img class="float-4" src="<?php echo get_template_directory_uri() ?>/img/top/bg_img01.png" alt="">
                </div>
                <div class="site-content-page-header-inner tb">
                    <div class="main-chatch">
                        <img class="popup" src="<?php echo get_template_directory_uri() ?>/img/top/popup.png" alt="">
                        <img src="<?php echo get_template_directory_uri() ?>/img/top/main-chatch.png" alt="">
                    </div>
                    <div class="seach-section">
                        <div class="section-header">
                            <p class="section-header-1">Ichihara is full of exciting job opportunities!</p>
                            <p class="section-header-2">
                                いちワクは豊かな自然環境と魅力的な地元産業が共存する市原の<br>
                                求人情報がギュッと詰まった<span>市原求人情報サイト</span>です。
                            </p>
                        </div>
                        <?php
