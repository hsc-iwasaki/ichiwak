        ...
        <?php endif;
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            if (!function_exists('jobhunt_company_job_listing')) {
                                                                                                                                                                                                                function jobhunt_company_job_listing()
                                                                                                                                                                                                                {
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    if (count($posts) > 0) {
        ?><div id="company-job_listings" class="company-job_listings">
                <h2><?php echo apply_filters('jobhunt_company_job_listing_title', esc_html__('Jobs From Business Network', 'jobhunt')); ?></h2>
                <ul><?php
