...
class JH_WPJM_Template_Loader {
    ...
    public static function init() {
        self::$jobs_page_id  = jh_wpjm_get_page_id( 'jobs' );
    ...
    private static function get_template_loader_default_file() {
        ...
        } elseif ( is_post_type_archive( 'job_listing' ) || is_page( self::$jobs_page_id ) || is_job_listing_taxonomy() ) {
...
add_action( 'init', array( 'JH_WPJM_Template_Loader', 'init' ) );